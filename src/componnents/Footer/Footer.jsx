...
const Footer = () => {
return (
    <footer className=" text-gray-300 relative overflow-hidden pt-16 pb-10 px-6 md:px-14 font-sans"
    
    >
        {/* Large circle top right */}
        <div className="hidden md:block absolute top-0 right-0 w-[300px] h-[300px] border-32 border-white rounded-full -translate-x-1/3 -translate-y-1/3 pointer-events-none" style={{borderWidth: "80px"}} aria-hidden="true"></div>
        {/* Large circle bottom left */}
        <div className=" hidden md:block absolute bottom-0 left-0 w-[300px] h-[300px] border-32 border-gray-600 rounded-full translate-x-1/3 translate-y-1/3 pointer-events-none" style={{borderWidth: "70px"}} aria-hidden="true"></div>
        ...
        <div className="flex flex-col space-y-3 min-w-[150px] md:min-w-[180px]">
            ...
            <a href="#" className="hover:text-white text-sm">Cookie Policy</a>
        </div>

        {/* Column 2 */}
        <div className="flex flex-col space-y-3 min-w-[150px] md:min-w-[180px]">
            <h4 className="text-white font-semibold text-sm mb-2">CONTACT</h4>
            <a href="tel:123456789" className="flex items-center gap-2 hover:text-white text-sm">
                <svg
            ...
            <a href="mailto:hola@liftmedia.com" className="flex items-center gap-2 hover:text-white text-sm">
                <svg
                className="w-4 h-4 text-blue-600"
                fill="none"
                stroke="currentColor"
